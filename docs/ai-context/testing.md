...
|---|---|---|---|
| Auth and Session | `CODE/be/tests/test_auth_api.py` | Login failure/success, register, register options, duplicate email, me/refresh, onboarding completion, change password, my projects, assignment counter | Auth payload/session contract, password rules, register rules, onboarding/profile/project assignment logic |
